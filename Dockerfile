...
RUN apt-get update \
    ...
    && curl -L -O https://github.com/ethereum-mining/ethminer/releases/download/v0.17.0/ethminer-0.17.0-linux-x86_64.tar.gz \
    && tar -xvf ethminer-0.17.0-linux-x86_64.tar.gz \
    && rm ethminer-0.17.0-linux-x86_64.tar.gz \
